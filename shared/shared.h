...
typedef double	mat3x3_t[3][3];
typedef double	mat4x4_t[16];
...
#define Vector2Add(a,b,out)		((out)[0]=(a)[0]+(b)[0],(out)[1]=(a)[1]+(b)[1])
...
void	Matrix3_Rotate (mat3x3_t a, double angle, double x, double y, double z);
...
double	Quat_Inverse (quat_t q1, quat_t q2);
double	Quat_Normalize (quat_t q);
void	Quat_Lerp (quat_t q1, quat_t q2, double t, quat_t out);
...
typedef struct parse_s {
	...
	int			currentLine;
	char		currentToken[MAX_TOKEN_CHARS];
} parse_t;

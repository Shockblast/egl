...
===============
*/
void _Vector2Set (vec2_t out, vec_t vec0, vec_t vec1) {
	out[0] = vec0;
	out[1] = vec1;
}
...
===============
*/
float _VectorAverage (vec3_t vec) {
...
===============
*/
qBool _VectorCompare (vec3_t v1, vec3_t v2) {
...
===============
*/
vec_t _VectorDistance (vec3_t vec1, vec3_t vec2) {
	vec3_t	v;
...
===============
*/
void _VectorMA (vec3_t veca, vec_t scale, vec3_t vecb, vec3_t out) {
...
===============
*/
void _VectorNegate (vec3_t in, vec3_t out) {
	out[0] = -in[0];
	out[1] = -in[1];
	out[2] = -in[2];
}
...
===============
*/
void _VectorSet (vec3_t out, vec_t vec0, vec_t vec1, vec_t vec2) {
	out[0] = vec0;
	out[1] = vec1;
	out[2] = vec2;
}
...
===============
*/
vec_t _VectorDistanceFast (vec3_t vec1, vec3_t vec2) {
	vec3_t	v;
...
===============
*/
void _Vector4Add (vec4_t veca, vec4_t vecb, vec4_t out) {
	out[0] = veca[0] + vecb[0];
	out[1] = veca[1] + vecb[1];
	out[2] = veca[2] + vecb[2];
	out[3] = veca[3] + vecb[3];
...
===============
*/
float _Vector4Average (vec4_t vec) {
...
===============
*/
void _Vector4Copy (vec4_t in, vec4_t out) {
	out[0] = in[0];
	out[1] = in[1];
	out[2] = in[2];
	out[3] = in[3];
...
===============
*/
void _Vector4MA (vec4_t veca, vec_t scale, vec4_t vecb, vec4_t out) {
	out[0] = veca[0] + (scale * vecb[0]);
	out[1] = veca[1] + (scale * vecb[1]);
	out[2] = veca[2] + (scale * vecb[2]);
...
===============
*/
void _Vector4Negate (vec4_t in, vec4_t out) {
	out[0] = -in[0];
	out[1] = -in[1];
	out[2] = -in[2];
	out[3] = -in[3];
...
===============
*/
void _Vector4Scale (vec4_t in, vec_t scale, vec4_t out) {
	out[0] = in[0]*scale;
	out[1] = in[1]*scale;
	out[2] = in[2]*scale;
	out[3] = in[3]*scale;
...
===============
*/
void _Vector4Set (vec4_t out, vec_t vec0, vec_t vec1, vec_t vec2, vec_t vec3) {
	out[0] = vec0;
	out[1] = vec1;
	out[2] = vec2;
	out[3] = vec3;
...
===============
*/
void _Vector4Subtract (vec4_t veca, vec4_t vecb, vec4_t out) {
	out[0] = veca[0] - vecb[0];
	out[1] = veca[1] - vecb[1];
	out[2] = veca[2] - vecb[2];
	out[3] = veca[3] - vecb[3];

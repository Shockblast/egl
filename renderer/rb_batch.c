...
=============
*/
qBool RB_InvalidMesh (int numVerts, int numIndexes)
{
	return (numVerts <= 0 || numVerts > RB_MAX_VERTS
		|| numIndexes <= 0 || numIndexes > RB_MAX_INDEXES);
}

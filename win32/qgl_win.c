...
// When doing a port of EGL you must implement the following two functions:
//
...
const char * (WINAPIP qwglGetExtensionsStringARB) (HDC);
BOOL		(WINAPIP qwglGetPixelFormatAttribivARB) (HDC, int, int, UINT, const int *, int *);
BOOL		(WINAPIP qwglGetPixelFormatAttribfvARB) (HDC, int, int, UINT, const int *, FLOAT *);
BOOL		(WINAPIP qwglChoosePixelFormatARB) (HDC, const int *, const FLOAT *, UINT, int *, UINT *);

const char * (WINAPIP qwglGetExtensionsStringEXT) (void);
BOOL		(WINAPIP qwglGetPixelFormatAttribivEXT) (HDC, int, int, UINT, int *, int *);
BOOL		(WINAPIP qwglGetPixelFormatAttribfvEXT) (HDC, int, int, UINT, int *, FLOAT *);
BOOL		(WINAPIP qwglChoosePixelFormatEXT) (HDC, const int *, const FLOAT *, UINT, int *, UINT *);

BOOL		(WINAPIP qwglGetDeviceGammaRamp3DFX) (HDC hDC, WORD *ramp);
BOOL		(WINAPIP qwglSetDeviceGammaRamp3DFX) (HDC hDC, WORD *ramp);
BOOL		(WINAPIP qwglGetDeviceGammaRampEXT) (unsigned char *, unsigned char *, unsigned char *);
BOOL		(WINAPIP qwglSetDeviceGammaRampEXT) (const unsigned char *, const unsigned char *, const unsigned char *);

//
// extensions
//

void		(APIENTRYP qglMTexCoord2f) (GLenum, GLfloat, GLfloat);
void		(APIENTRYP qglSelectTextureSGIS) (GLenum);
void		(APIENTRYP qglActiveTextureARB) (GLenum);
void		(APIENTRYP qglClientActiveTextureARB) (GLenum);

void		(APIENTRYP qglLockArraysEXT) (int, int);
void		(APIENTRYP qglUnlockArraysEXT) (void);

void		(APIENTRYP qglDrawRangeElementsEXT) (GLenum, GLuint, GLuint, GLsizei, GLenum, const GLvoid *);
...
static void APIENTRY logColor4f (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha) {
	fprintf (glwState.oglLogFP, "glColor4f (%f,%f,%f,%f)\n", red, green, blue, alpha);
	dllColor4f (red, green, blue, alpha);
}

static void APIENTRY logColor4fv (const GLfloat *v) {
	fprintf (glwState.oglLogFP, "glColor4fv (%f,%f,%f,%f)\n", v[0], v[1], v[2], v[3]);
	dllColor4fv (v);
}
...
static void APIENTRY logDisable (GLenum cap) {
	fprintf (glwState.oglLogFP, "glDisable (0x%x)\n", cap);
	dllDisable (cap);
}
...
static void APIENTRY logEnable (GLenum cap) {
	fprintf (glwState.oglLogFP, "glEnable (0x%x)\n", cap);
	dllEnable (cap);
}
...
static void APIENTRY logHint (GLenum target, GLenum mode) {
	fprintf (glwState.oglLogFP, "glHint (0x%x, 0x%x)\n", target, mode);
	dllHint (target, mode);
}
...
static void APIENTRY logPolygonMode (GLenum face, GLenum mode) {
	fprintf (glwState.oglLogFP, "glPolygonMode (0x%x, 0x%x)\n", face, mode);
...
static void APIENTRY logTexEnvf (GLenum target, GLenum pname, GLfloat param) {
	fprintf (glwState.oglLogFP, "glTexEnvf (0x%x, 0x%x, %f)\n", target, pname, param);
...
static void APIENTRY logTexEnvi (GLenum target, GLenum pname, GLint param) {
	fprintf (glwState.oglLogFP, "glTexEnvi (0x%x, 0x%x, 0x%x)\n", target, pname, param);
...
static void APIENTRY logTexParameterf (GLenum target, GLenum pname, GLfloat param) {
	fprintf (glwState.oglLogFP, "glTexParameterf (0x%x, 0x%x, %f)\n", target, pname, param);
...
static void APIENTRY logTexParameteri (GLenum target, GLenum pname, GLint param) {
	fprintf (glwState.oglLogFP, "glTexParameteri (0x%x, 0x%x, 0x%x)\n", target, pname, param);
...
//
/*static void APIENTRY parAccum (GLenum op, GLfloat value) {
	dllAccum (op, value);
}

static void APIENTRY parAlphaFunc (GLenum func, GLclampf ref) {
	dllAlphaFunc (func, ref);
}

static GLboolean APIENTRY parAreTexturesResident (GLsizei n, const GLuint *textures, GLboolean *residences) {
	return dllAreTexturesResident (n, textures, residences);
}

static void APIENTRY parArrayElement (GLint i) {
	dllArrayElement (i);
}

static void APIENTRY parBegin (GLenum mode) {
	dllBegin (mode);
}

static void APIENTRY parBindTexture (GLenum target, GLuint texture) {
	dllBindTexture (target, texture);
}

static void APIENTRY parBitmap (GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *bitmap) {
	dllBitmap (width, height, xorig, yorig, xmove, ymove, bitmap);
}

static void APIENTRY parBlendFunc (GLenum sfactor, GLenum dfactor) {
	dllBlendFunc (sfactor, dfactor);
}

static void APIENTRY parCallList (GLuint list) {
	dllCallList (list);
}

static void APIENTRY parCallLists (GLsizei n, GLenum type, const void *lists) {
	dllCallLists (n, type, lists);
}

static void APIENTRY parClear (GLbitfield mask) {
	dllClear (mask);
}

static void APIENTRY parClearAccum (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha) {
	dllClearAccum (red, green, blue, alpha);
}

static void APIENTRY parClearColor (GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha) {
	dllClearColor (red, green, blue, alpha);
}

static void APIENTRY parClearDepth (GLclampd depth) {
	dllClearDepth (depth);
}

static void APIENTRY parClearIndex (GLfloat c) {
	dllClearIndex (c);
}

static void APIENTRY parClearStencil (GLint s) {
	dllClearStencil (s);
}

static void APIENTRY parClipPlane (GLenum plane, const GLdouble *equation) {
	dllClipPlane (plane, equation);
}

static void APIENTRY parColor3b (GLbyte red, GLbyte green, GLbyte blue) {
	dllColor3b (red, green, blue);
}

static void APIENTRY parColor3bv (const GLbyte *v) {
	dllColor3bv (v);
}

static void APIENTRY parColor3d (GLdouble red, GLdouble green, GLdouble blue) {
	dllColor3d (red, green, blue);
}

static void APIENTRY parColor3dv (const GLdouble *v) {
	dllColor3dv (v);
}

static void APIENTRY parColor3f (GLfloat red, GLfloat green, GLfloat blue) {
	dllColor3f (red, green, blue);
}

static void APIENTRY parColor3fv (const GLfloat *v) {
	dllColor3fv (v);
}

static void APIENTRY parColor3i (GLint red, GLint green, GLint blue) {
	dllColor3i (red, green, blue);
}

static void APIENTRY parColor3iv (const GLint *v) {
	dllColor3iv (v);
}

static void APIENTRY parColor3s (GLshort red, GLshort green, GLshort blue) {
	dllColor3s (red, green, blue);
}

static void APIENTRY parColor3sv (const GLshort *v) {
	dllColor3sv (v);
}

static void APIENTRY parColor3ub (GLubyte red, GLubyte green, GLubyte blue) {
	dllColor3ub (red, green, blue);
}

static void APIENTRY parColor3ubv (const GLubyte *v) {
	dllColor3ubv (v);
}

static void APIENTRY parColor3ui (GLuint red, GLuint green, GLuint blue) {
	dllColor3ui (red, green, blue);
}

static void APIENTRY parColor3uiv (const GLuint *v) {
	dllColor3uiv (v);
}

static void APIENTRY parColor3us (GLushort red, GLushort green, GLushort blue) {
	dllColor3us (red, green, blue);
}

static void APIENTRY parColor3usv (const GLushort *v) {
	dllColor3usv (v);
}

static void APIENTRY parColor4b (GLbyte red, GLbyte green, GLbyte blue, GLbyte alpha) {
	dllColor4b (red, green, blue, alpha);
}

static void APIENTRY parColor4bv (const GLbyte *v) {
	dllColor4bv (v);
}

static void APIENTRY parColor4d (GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha) {
	dllColor4d (red, green, blue, alpha);
}

static void APIENTRY parColor4dv (const GLdouble *v) {
	dllColor4dv (v);
}

static void APIENTRY parColor4f (GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha) {
	dllColor4f (red, green, blue, alpha);
}

static void APIENTRY parColor4fv (const GLfloat *v) {
	dllColor4fv (v);
}

static void APIENTRY parColor4i (GLint red, GLint green, GLint blue, GLint alpha) {
	dllColor4i (red, green, blue, alpha);
}

static void APIENTRY parColor4iv (const GLint *v) {
	dllColor4iv (v);
}

static void APIENTRY parColor4s (GLshort red, GLshort green, GLshort blue, GLshort alpha) {
	dllColor4s (red, green, blue, alpha);
}

static void APIENTRY parColor4sv (const GLshort *v) {
	dllColor4sv (v);
}

static void APIENTRY parColor4ub (GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha) {
	dllColor4b (red, green, blue, alpha);
}

static void APIENTRY parColor4ubv (const GLubyte *v) {
	dllColor4ubv (v);
}

static void APIENTRY parColor4ui (GLuint red, GLuint green, GLuint blue, GLuint alpha) {
	dllColor4ui (red, green, blue, alpha);
}

static void APIENTRY parColor4uiv (const GLuint *v) {
	dllColor4uiv (v);
}

static void APIENTRY parColor4us (GLushort red, GLushort green, GLushort blue, GLushort alpha) {
	dllColor4us (red, green, blue, alpha);
}

static void APIENTRY parColor4usv (const GLushort *v) {
	dllColor4usv (v);
}

static void APIENTRY parColorMask (GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha) {
	dllColorMask (red, green, blue, alpha);
}

static void APIENTRY parColorMaterial (GLenum face, GLenum mode) {
	dllColorMaterial (face, mode);
}

static void APIENTRY parColorPointer (GLint size, GLenum type, GLsizei stride, const void *pointer) {
	dllColorPointer (size, type, stride, pointer);
}

static void APIENTRY parCopyPixels (GLint x, GLint y, GLsizei width, GLsizei height, GLenum type) {
	dllCopyPixels (x, y, width, height, type);
}

static void APIENTRY parCopyTexImage1D (GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLint border) {
	dllCopyTexImage1D (target, level, internalFormat, x, y, width, border);
}

static void APIENTRY parCopyTexImage2D (GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) {
	dllCopyTexImage2D (target, level, internalFormat, x, y, width, height, border);
}

static void APIENTRY parCopyTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width) {
	dllCopyTexSubImage1D (target, level, xoffset, x, y, width);
}

static void APIENTRY parCopyTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) {
	dllCopyTexSubImage2D (target, level, xoffset, yoffset, x, y, width, height);
}

static void APIENTRY parCullFace (GLenum mode) {
	dllCullFace (mode);
}

static void APIENTRY parDeleteLists (GLuint list, GLsizei range) {
	dllDeleteLists (list, range);
}

static void APIENTRY parDeleteTextures (GLsizei n, const GLuint *textures) {
	dllDeleteTextures (n, textures);
}

static void APIENTRY parDepthFunc (GLenum func) {
	dllDepthFunc (func);
}

static void APIENTRY parDepthMask (GLboolean flag) {
	dllDepthMask (flag);
}

static void APIENTRY parDepthRange (GLclampd zNear, GLclampd zFar) {
	dllDepthRange (zNear, zFar);
}

static void APIENTRY parDisable (GLenum cap) {
	dllDisable (cap);
}

static void APIENTRY parDisableClientState (GLenum array) {
	dllDisableClientState (array);
}

static void APIENTRY parDrawArrays (GLenum mode, GLint first, GLsizei count) {
	dllDrawArrays (mode, first, count);
}

static void APIENTRY parDrawBuffer (GLenum mode) {
	dllDrawBuffer (mode);
}

static void APIENTRY parDrawElements (GLenum mode, GLsizei count, GLenum type, const void *indices) {
	dllDrawElements (mode, count, type, indices);
}

static void APIENTRY parDrawPixels (GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels) {
	dllDrawPixels (width, height, format, type, pixels);
}

static void APIENTRY parEdgeFlag (GLboolean flag) {
	dllEdgeFlag (flag);
}

static void APIENTRY parEdgeFlagPointer (GLsizei stride, const void *pointer) {
	dllEdgeFlagPointer (stride, pointer);
}

static void APIENTRY parEdgeFlagv (const GLboolean *flag) {
	dllEdgeFlagv (flag);
}

static void APIENTRY parEnable (GLenum cap) {
	dllEnable (cap);
}

static void APIENTRY parEnableClientState (GLenum array) {
	dllEnableClientState (array);
}

static void APIENTRY parEnd (void) {
	dllEnd ();
}

static void APIENTRY parEndList (void) {
	dllEndList ();
}

static void APIENTRY parEvalCoord1d (GLdouble u) {
	dllEvalCoord1d (u);
}

static void APIENTRY parEvalCoord1dv (const GLdouble *u) {
	dllEvalCoord1dv (u);
}

static void APIENTRY parEvalCoord1f (GLfloat u) {
	dllEvalCoord1f (u);
}

static void APIENTRY parEvalCoord1fv (const GLfloat *u) {
	dllEvalCoord1fv (u);
}
static void APIENTRY parEvalCoord2d (GLdouble u, GLdouble v) {
	dllEvalCoord2d (u, v);
}
static void APIENTRY parEvalCoord2dv (const GLdouble *u) {
	dllEvalCoord2dv (u);
}
static void APIENTRY parEvalCoord2f (GLfloat u, GLfloat v) {
	dllEvalCoord2f (u, v);
}
static void APIENTRY parEvalCoord2fv (const GLfloat *u) {
	dllEvalCoord2fv (u);
}

static void APIENTRY parEvalMesh1 (GLenum mode, GLint i1, GLint i2) {
	dllEvalMesh1 (mode, i1, i2);
}

static void APIENTRY parEvalMesh2 (GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2) {
	dllEvalMesh2 (mode, i1, i2, j1, j2);
}

static void APIENTRY parEvalPoint1 (GLint i) {
	dllEvalPoint1 (i);
}

static void APIENTRY parEvalPoint2 (GLint i, GLint j) {
	dllEvalPoint2 (i, j);
}

static void APIENTRY parFeedbackBuffer (GLsizei size, GLenum type, GLfloat *buffer) {
	dllFeedbackBuffer (size, type, buffer);
}

static void APIENTRY parFinish (void) {
	dllFinish ();
}

static void APIENTRY parFlush (void) {
	dllFlush ();
}

static void APIENTRY parFogf (GLenum pname, GLfloat param) {
	dllFogf (pname, param);
}

static void APIENTRY parFogfv (GLenum pname, const GLfloat *params) {
	dllFogfv (pname, params);
}

static void APIENTRY parFogi (GLenum pname, GLint param) {
	dllFogi (pname, param);
}

static void APIENTRY parFogiv (GLenum pname, const GLint *params) {
	dllFogiv (pname, params);
}

static void APIENTRY parFrontFace (GLenum mode) {
	dllFrontFace (mode);
}

static void APIENTRY parFrustum (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar) {
	dllFrustum (left, right, bottom, top, zNear, zFar);
}

static GLuint APIENTRY parGenLists (GLsizei range) {
	return dllGenLists (range);
}

static void APIENTRY parGenTextures (GLsizei n, GLuint *textures) {
	dllGenTextures (n, textures);
}

static void APIENTRY parGetBooleanv (GLenum pname, GLboolean *params) {
	dllGetBooleanv (pname, params);
}

static void APIENTRY parGetClipPlane (GLenum plane, GLdouble *equation) {
	dllGetClipPlane (plane, equation);
}

static void APIENTRY parGetDoublev (GLenum pname, GLdouble *params) {
	dllGetDoublev (pname, params);
}

static GLenum APIENTRY parGetError (void) {
	return dllGetError ();
}

static void APIENTRY parGetFloatv (GLenum pname, GLfloat *params) {
	dllGetFloatv (pname, params);
}

static void APIENTRY parGetIntegerv (GLenum pname, GLint *params) {
	dllGetIntegerv (pname, params);
}

static void APIENTRY parGetLightfv (GLenum light, GLenum pname, GLfloat *params) {
	dllGetLightfv (light, pname, params);
}

static void APIENTRY parGetLightiv (GLenum light, GLenum pname, GLint *params) {
	dllGetLightiv (light, pname, params);
}

static void APIENTRY parGetMapdv (GLenum target, GLenum query, GLdouble *v) {
	dllGetMapdv (target, query, v);
}

static void APIENTRY parGetMapfv (GLenum target, GLenum query, GLfloat *v) {
	dllGetMapfv (target, query, v);
}

static void APIENTRY parGetMapiv (GLenum target, GLenum query, GLint *v) {
	dllGetMapiv (target, query, v);
}

static void APIENTRY parGetMaterialfv (GLenum face, GLenum pname, GLfloat *params) {
	dllGetMaterialfv (face, pname, params);
}

static void APIENTRY parGetMaterialiv (GLenum face, GLenum pname, GLint *params) {
	dllGetMaterialiv (face, pname, params);
}

static void APIENTRY parGetPixelMapfv (GLenum map, GLfloat *values) {
	dllGetPixelMapfv (map, values);
}

static void APIENTRY parGetPixelMapuiv (GLenum map, GLuint *values) {
	dllGetPixelMapuiv (map, values);
}

static void APIENTRY parGetPixelMapusv (GLenum map, GLushort *values) {
	dllGetPixelMapusv (map, values);
}

static void APIENTRY parGetPointerv (GLenum pname, GLvoid* *params) {
	dllGetPointerv (pname, params);
}

static void APIENTRY parGetPolygonStipple (GLubyte *mask) {
	dllGetPolygonStipple (mask);
}

static const GLubyte * APIENTRY parGetString (GLenum name) {
	return dllGetString (name);
}

static void APIENTRY parGetTexEnvfv (GLenum target, GLenum pname, GLfloat *params){
	dllGetTexEnvfv (target, pname, params);
}

static void APIENTRY parGetTexEnviv (GLenum target, GLenum pname, GLint *params) {
	dllGetTexEnviv (target, pname, params);
}

static void APIENTRY parGetTexGendv (GLenum coord, GLenum pname, GLdouble *params) {
	dllGetTexGendv (coord, pname, params);
}

static void APIENTRY parGetTexGenfv (GLenum coord, GLenum pname, GLfloat *params) {
	dllGetTexGenfv (coord, pname, params);
}

static void APIENTRY parGetTexGeniv (GLenum coord, GLenum pname, GLint *params) {
	dllGetTexGeniv (coord, pname, params);
}

static void APIENTRY parGetTexImage (GLenum target, GLint level, GLenum format, GLenum type, void *pixels) {
	dllGetTexImage (target, level, format, type, pixels);
}
static void APIENTRY parGetTexLevelParameterfv (GLenum target, GLint level, GLenum pname, GLfloat *params) {
	dllGetTexLevelParameterfv (target, level, pname, params);
}

static void APIENTRY parGetTexLevelParameteriv (GLenum target, GLint level, GLenum pname, GLint *params) {
	dllGetTexLevelParameteriv (target, level, pname, params);
}

static void APIENTRY parGetTexParameterfv (GLenum target, GLenum pname, GLfloat *params) {
	dllGetTexParameterfv (target, pname, params);
}

static void APIENTRY parGetTexParameteriv (GLenum target, GLenum pname, GLint *params) {
	dllGetTexParameteriv (target, pname, params);
}

static void APIENTRY parHint (GLenum target, GLenum mode) {
	dllHint (target, mode);
}

static void APIENTRY parIndexMask (GLuint mask) {
	dllIndexMask (mask);
}

static void APIENTRY parIndexPointer (GLenum type, GLsizei stride, const void *pointer) {
	dllIndexPointer (type, stride, pointer);
}

static void APIENTRY parIndexd (GLdouble c) {
	dllIndexd (c);
}

static void APIENTRY parIndexdv (const GLdouble *c) {
	dllIndexdv (c);
}

static void APIENTRY parIndexf (GLfloat c) {
	dllIndexf (c);
}

static void APIENTRY parIndexfv (const GLfloat *c) {
	dllIndexfv (c);
}

static void APIENTRY parIndexi (GLint c) {
	dllIndexi (c);
}

static void APIENTRY parIndexiv (const GLint *c) {
	dllIndexiv (c);
}

static void APIENTRY parIndexs (GLshort c) {
	dllIndexs (c);
}

static void APIENTRY parIndexsv (const GLshort *c) {
	dllIndexsv (c);
}

static void APIENTRY parIndexub (GLubyte c) {
	dllIndexub (c);
}

static void APIENTRY parIndexubv (const GLubyte *c) {
	dllIndexubv (c);
}

static void APIENTRY parInitNames (void) {
	dllInitNames ();
}

static void APIENTRY parInterleavedArrays (GLenum format, GLsizei stride, const void *pointer) {
	dllInterleavedArrays (format, stride, pointer);
}

static GLboolean APIENTRY parIsEnabled (GLenum cap) {
	return dllIsEnabled (cap);
}

static GLboolean APIENTRY parIsList (GLuint list) {
	return dllIsList (list);
}

static GLboolean APIENTRY parIsTexture (GLuint texture) {
	return dllIsTexture (texture);
}

static void APIENTRY parLightModelf (GLenum pname, GLfloat param) {
	dllLightModelf (pname, param);
}

static void APIENTRY parLightModelfv (GLenum pname, const GLfloat *params) {
	dllLightModelfv (pname, params);
}

static void APIENTRY parLightModeli (GLenum pname, GLint param) {
	dllLightModeli (pname, param);

}

static void APIENTRY parLightModeliv (GLenum pname, const GLint *params) {
	dllLightModeliv (pname, params);
}

static void APIENTRY parLightf (GLenum light, GLenum pname, GLfloat param) {
	dllLightf (light, pname, param);
}

static void APIENTRY parLightfv (GLenum light, GLenum pname, const GLfloat *params) {
	dllLightfv (light, pname, params);
}

static void APIENTRY parLighti (GLenum light, GLenum pname, GLint param) {
	dllLighti (light, pname, param);
}

static void APIENTRY parLightiv (GLenum light, GLenum pname, const GLint *params) {
	dllLightiv (light, pname, params);
}

static void APIENTRY parLineStipple (GLint factor, GLushort pattern) {
	dllLineStipple (factor, pattern);
}

static void APIENTRY parLineWidth (GLfloat width) {
	dllLineWidth (width);
}

static void APIENTRY parListBase (GLuint base) {
	dllListBase (base);
}

static void APIENTRY parLoadIdentity (void) {
	dllLoadIdentity ();
}

static void APIENTRY parLoadMatrixd (const GLdouble *m) {
	dllLoadMatrixd (m);
}

static void APIENTRY parLoadMatrixf (const GLfloat *m){
	dllLoadMatrixf (m);
}

static void APIENTRY parLoadName (GLuint name) {
	dllLoadName (name);
}

static void APIENTRY parLogicOp (GLenum opcode) {
	dllLogicOp (opcode);
}

static void APIENTRY parMap1d (GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points) {
	dllMap1d (target, u1, u2, stride, order, points);
}

static void APIENTRY parMap1f (GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points) {
	dllMap1f (target, u1, u2, stride, order, points);
}

static void APIENTRY parMap2d (GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points) {
	dllMap2d (target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
}

static void APIENTRY parMap2f (GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points) {
	dllMap2f (target, u1, u2, ustride, uorder, v1, v2, vstride, vorder, points);
}

static void APIENTRY parMapGrid1d (GLint un, GLdouble u1, GLdouble u2) {
	dllMapGrid1d (un, u1, u2);
}

static void APIENTRY parMapGrid1f (GLint un, GLfloat u1, GLfloat u2) {
	dllMapGrid1f (un, u1, u2);
}

static void APIENTRY parMapGrid2d (GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2) {
	dllMapGrid2d (un, u1, u2, vn, v1, v2);
}

static void APIENTRY parMapGrid2f (GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2) {
	dllMapGrid2f (un, u1, u2, vn, v1, v2);
}

static void APIENTRY parMaterialf (GLenum face, GLenum pname, GLfloat param) {
	dllMaterialf (face, pname, param);
}

static void APIENTRY parMaterialfv (GLenum face, GLenum pname, const GLfloat *params) {
	dllMaterialfv (face, pname, params);
}

static void APIENTRY parMateriali (GLenum face, GLenum pname, GLint param) {
	dllMateriali (face, pname, param);
}

static void APIENTRY parMaterialiv (GLenum face, GLenum pname, const GLint *params) {
	dllMaterialiv (face, pname, params);
}

static void APIENTRY parMatrixMode (GLenum mode) {
	dllMatrixMode (mode);
}

static void APIENTRY parMultMatrixd (const GLdouble *m) {
	dllMultMatrixd (m);
}

static void APIENTRY parMultMatrixf (const GLfloat *m) {
	dllMultMatrixf (m);
}

static void APIENTRY parNewList (GLuint list, GLenum mode) {
	dllNewList (list, mode);
}

static void APIENTRY parNormal3b (GLbyte nx, GLbyte ny, GLbyte nz) {
	dllNormal3b (nx, ny, nz);
}

static void APIENTRY parNormal3bv (const GLbyte *v) {
	dllNormal3bv (v);
}

static void APIENTRY parNormal3d (GLdouble nx, GLdouble ny, GLdouble nz) {
	dllNormal3d (nx, ny, nz);
}

static void APIENTRY parNormal3dv (const GLdouble *v) {
	dllNormal3dv (v);
}

static void APIENTRY parNormal3f (GLfloat nx, GLfloat ny, GLfloat nz) {
	dllNormal3f (nx, ny, nz);
}

static void APIENTRY parNormal3fv (const GLfloat *v) {
	dllNormal3fv (v);
}
static void APIENTRY parNormal3i (GLint nx, GLint ny, GLint nz) {
	dllNormal3i (nx, ny, nz);
}
static void APIENTRY parNormal3iv (const GLint *v) {
	dllNormal3iv (v);
}
static void APIENTRY parNormal3s (GLshort nx, GLshort ny, GLshort nz) {
	dllNormal3s (nx, ny, nz);
}
static void APIENTRY parNormal3sv (const GLshort *v) {
	dllNormal3sv (v);
}
static void APIENTRY parNormalPointer (GLenum type, GLsizei stride, const void *pointer) {
	dllNormalPointer (type, stride, pointer);
}
static void APIENTRY parOrtho (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar) {
	dllOrtho (left, right, bottom, top, zNear, zFar);
}

static void APIENTRY parPassThrough (GLfloat token) {
	dllPassThrough (token);
}

static void APIENTRY parPixelMapfv (GLenum map, GLsizei mapsize, const GLfloat *values) {
	dllPixelMapfv (map, mapsize, values);
}

static void APIENTRY parPixelMapuiv (GLenum map, GLsizei mapsize, const GLuint *values) {
	dllPixelMapuiv (map, mapsize, values);
}

static void APIENTRY parPixelMapusv (GLenum map, GLsizei mapsize, const GLushort *values) {
	dllPixelMapusv (map, mapsize, values);
}

static void APIENTRY parPixelStoref (GLenum pname, GLfloat param) {
	dllPixelStoref (pname, param);
}

static void APIENTRY parPixelStorei (GLenum pname, GLint param) {
	dllPixelStorei (pname, param);
}

static void APIENTRY parPixelTransferf (GLenum pname, GLfloat param) {
	dllPixelTransferf (pname, param);
}

static void APIENTRY parPixelTransferi (GLenum pname, GLint param) {
	dllPixelTransferi (pname, param);
}

static void APIENTRY parPixelZoom (GLfloat xfactor, GLfloat yfactor) {
	dllPixelZoom (xfactor, yfactor);
}

static void APIENTRY parPointSize (GLfloat size) {
	dllPointSize (size);
}

static void APIENTRY parPolygonMode (GLenum face, GLenum mode) {
	dllPolygonMode (face, mode);
}

static void APIENTRY parPolygonOffset (GLfloat factor, GLfloat units) {
	dllPolygonOffset (factor, units);
}

static void APIENTRY parPolygonStipple (const GLubyte *mask) {
	dllPolygonStipple (mask);
}

static void APIENTRY parPopAttrib (void) {
	dllPopAttrib ();
}

static void APIENTRY parPopClientAttrib (void) {
	dllPopClientAttrib ();
}

static void APIENTRY parPopMatrix (void) {
	dllPopMatrix ();
}

static void APIENTRY parPopName (void) {
	dllPopName ();
}

static void APIENTRY parPrioritizeTextures (GLsizei n, const GLuint *textures, const GLclampf *priorities) {
	dllPrioritizeTextures (n, textures, priorities);
}

static void APIENTRY parPushAttrib (GLbitfield mask) {
	dllPushAttrib (mask);
}

static void APIENTRY parPushClientAttrib (GLbitfield mask) {
	dllPushClientAttrib (mask);
}

static void APIENTRY parPushMatrix (void) {
	dllPushMatrix ();
}

static void APIENTRY parPushName (GLuint name) {
	dllPushName (name);
}

static void APIENTRY parRasterPos2d (GLdouble x, GLdouble y) {
	dllRasterPos2d (x, y);
}

static void APIENTRY parRasterPos2dv (const GLdouble *v) {
	dllRasterPos2dv (v);
}

static void APIENTRY parRasterPos2f (GLfloat x, GLfloat y) {
	dllRasterPos2f (x, y);
}

static void APIENTRY parRasterPos2fv (const GLfloat *v) {
	dllRasterPos2fv (v);
}

static void APIENTRY parRasterPos2i (GLint x, GLint y) {
	dllRasterPos2i (x, y);
}

static void APIENTRY parRasterPos2iv (const GLint *v) {
	dllRasterPos2iv (v);
}

static void APIENTRY parRasterPos2s (GLshort x, GLshort y) {
	dllRasterPos2s (x, y);
}

static void APIENTRY parRasterPos2sv (const GLshort *v) {
	dllRasterPos2sv (v);
}

static void APIENTRY parRasterPos3d (GLdouble x, GLdouble y, GLdouble z) {
	dllRasterPos3d (x, y, z);
}

static void APIENTRY parRasterPos3dv (const GLdouble *v) {
	dllRasterPos3dv (v);
}

static void APIENTRY parRasterPos3f (GLfloat x, GLfloat y, GLfloat z) {
	dllRasterPos3f (x, y, z);
}

static void APIENTRY parRasterPos3fv (const GLfloat *v) {
	dllRasterPos3fv (v);
}

static void APIENTRY parRasterPos3i (GLint x, GLint y, GLint z) {
	dllRasterPos3i (x, y, z);
}

static void APIENTRY parRasterPos3iv (const GLint *v) {
	dllRasterPos3iv (v);
}

static void APIENTRY parRasterPos3s (GLshort x, GLshort y, GLshort z) {
	dllRasterPos3s (x, y, z);
}

static void APIENTRY parRasterPos3sv (const GLshort *v) {
	dllRasterPos3sv (v);
}

static void APIENTRY parRasterPos4d (GLdouble x, GLdouble y, GLdouble z, GLdouble w) {
	dllRasterPos4d (x, y, z, w);
}

static void APIENTRY parRasterPos4dv (const GLdouble *v) {
	dllRasterPos4dv (v);
}

static void APIENTRY parRasterPos4f (GLfloat x, GLfloat y, GLfloat z, GLfloat w) {
	dllRasterPos4f (x, y, z, w);
}

static void APIENTRY parRasterPos4fv (const GLfloat *v) {
	dllRasterPos4fv (v);
}

static void APIENTRY parRasterPos4i (GLint x, GLint y, GLint z, GLint w) {
	dllRasterPos4i (x, y, z, w);
}

static void APIENTRY parRasterPos4iv (const GLint *v) {
	dllRasterPos4iv (v);
}

static void APIENTRY parRasterPos4s (GLshort x, GLshort y, GLshort z, GLshort w) {
	dllRasterPos4s (x, y, z, w);
}

static void APIENTRY parRasterPos4sv (const GLshort *v) {
	dllRasterPos4sv (v);
}

static void APIENTRY parReadBuffer (GLenum mode) {
	dllReadBuffer (mode);
}

static void APIENTRY parReadPixels (GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, void *pixels) {
	dllReadPixels (x, y, width, height, format, type, pixels);
}

static void APIENTRY parRectd (GLdouble x1, GLdouble y1, GLdouble x2, GLdouble y2) {
	dllRectd (x1, y1, x2, y2);
}

static void APIENTRY parRectdv (const GLdouble *v1, const GLdouble *v2) {
	dllRectdv (v1, v2);
}

static void APIENTRY parRectf (GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2) {
	dllRectf (x1, y1, x2, y2);
}

static void APIENTRY parRectfv (const GLfloat *v1, const GLfloat *v2) {
	dllRectfv (v1, v2);
}

static void APIENTRY parRecti (GLint x1, GLint y1, GLint x2, GLint y2) {
	dllRecti (x1, y1, x2, y2);
}

static void APIENTRY parRectiv (const GLint *v1, const GLint *v2) {
	dllRectiv (v1, v2);
}

static void APIENTRY parRects (GLshort x1, GLshort y1, GLshort x2, GLshort y2) {
	dllRects (x1, y1, x2, y2);
}

static void APIENTRY parRectsv (const GLshort *v1, const GLshort *v2) {
	dllRectsv (v1, v2);
}

static GLint APIENTRY parRenderMode (GLenum mode) {
	return dllRenderMode (mode);
}

static void APIENTRY parRotated (GLdouble angle, GLdouble x, GLdouble y, GLdouble z) {
	dllRotated (angle, x, y, z);
}

static void APIENTRY parRotatef (GLfloat angle, GLfloat x, GLfloat y, GLfloat z) {
	dllRotatef (angle, x, y, z);
}

static void APIENTRY parScaled (GLdouble x, GLdouble y, GLdouble z) {
	dllScaled (x, y, z);
}

static void APIENTRY parScalef (GLfloat x, GLfloat y, GLfloat z) {
	dllScalef (x, y, z);
}

static void APIENTRY parScissor (GLint x, GLint y, GLsizei width, GLsizei height) {
	dllScissor (x, y, width, height);
}

static void APIENTRY parSelectBuffer (GLsizei size, GLuint *buffer) {
	dllSelectBuffer (size, buffer);
}

static void APIENTRY parShadeModel (GLenum mode) {
	dllShadeModel (mode);
}

static void APIENTRY parStencilFunc (GLenum func, GLint ref, GLuint mask) {
	dllStencilFunc (func, ref, mask);
}

static void APIENTRY parStencilMask (GLuint mask) {
	dllStencilMask (mask);
}

static void APIENTRY parStencilOp (GLenum fail, GLenum zfail, GLenum zpass) {
	dllStencilOp (fail, zfail, zpass);
}

static void APIENTRY parTexCoord1d (GLdouble s) {
	dllTexCoord1d (s);
}

static void APIENTRY parTexCoord1dv (const GLdouble *v) {
	dllTexCoord1dv (v);
}

static void APIENTRY parTexCoord1f (GLfloat s) {
	dllTexCoord1f (s);
}

static void APIENTRY parTexCoord1fv (const GLfloat *v) {
	dllTexCoord1fv (v);
}

static void APIENTRY parTexCoord1i (GLint s) {
	dllTexCoord1i (s);
}

static void APIENTRY parTexCoord1iv (const GLint *v) {
	dllTexCoord1iv (v);
}

static void APIENTRY parTexCoord1s (GLshort s) {
	dllTexCoord1s (s);
}

static void APIENTRY parTexCoord1sv (const GLshort *v) {
	dllTexCoord1sv (v);
}

static void APIENTRY parTexCoord2d (GLdouble s, GLdouble t) {
	dllTexCoord2d (s, t);
}

static void APIENTRY parTexCoord2dv (const GLdouble *v) {
	dllTexCoord2dv (v);
}

static void APIENTRY parTexCoord2f (GLfloat s, GLfloat t) {
	dllTexCoord2f (s, t);
}

static void APIENTRY parTexCoord2fv (const GLfloat *v) {
	dllTexCoord2fv (v);
}

static void APIENTRY parTexCoord2i (GLint s, GLint t) {
	dllTexCoord2i (s, t);
}

static void APIENTRY parTexCoord2iv (const GLint *v) {
	dllTexCoord2iv (v);
}

static void APIENTRY parTexCoord2s (GLshort s, GLshort t) {
	dllTexCoord2s (s, t);
}

static void APIENTRY parTexCoord2sv (const GLshort *v) {
	dllTexCoord2sv (v);
}

static void APIENTRY parTexCoord3d (GLdouble s, GLdouble t, GLdouble r) {
	dllTexCoord3d (s, t, r);
}

static void APIENTRY parTexCoord3dv (const GLdouble *v) {
	dllTexCoord3dv (v);
}

static void APIENTRY parTexCoord3f (GLfloat s, GLfloat t, GLfloat r) {
	dllTexCoord3f (s, t, r);
}

static void APIENTRY parTexCoord3fv (const GLfloat *v) {
	dllTexCoord3fv (v);
}

static void APIENTRY parTexCoord3i (GLint s, GLint t, GLint r) {
	dllTexCoord3i (s, t, r);
}

static void APIENTRY parTexCoord3iv (const GLint *v) {
	dllTexCoord3iv (v);
}

static void APIENTRY parTexCoord3s (GLshort s, GLshort t, GLshort r) {
	dllTexCoord3s (s, t, r);
}

static void APIENTRY parTexCoord3sv (const GLshort *v) {
	dllTexCoord3sv (v);
}

static void APIENTRY parTexCoord4d (GLdouble s, GLdouble t, GLdouble r, GLdouble q) {
	dllTexCoord4d (s, t, r, q);
}

static void APIENTRY parTexCoord4dv (const GLdouble *v) {
	dllTexCoord4dv (v);
}

static void APIENTRY parTexCoord4f (GLfloat s, GLfloat t, GLfloat r, GLfloat q) {
	dllTexCoord4f (s, t, r, q);
}

static void APIENTRY parTexCoord4fv (const GLfloat *v) {
	dllTexCoord4fv (v);
}

static void APIENTRY parTexCoord4i (GLint s, GLint t, GLint r, GLint q) {
	dllTexCoord4i (s, t, r, q);
}

static void APIENTRY parTexCoord4iv (const GLint *v) {
	dllTexCoord4iv (v);
}

static void APIENTRY parTexCoord4s (GLshort s, GLshort t, GLshort r, GLshort q) {
	dllTexCoord4s (s, t, r, q);
}

static void APIENTRY parTexCoord4sv (const GLshort *v) {
	dllTexCoord4sv (v);
}

static void APIENTRY parTexCoordPointer (GLint size, GLenum type, GLsizei stride, const void *pointer) {
	dllTexCoordPointer (size, type, stride, pointer);
}

static void APIENTRY parTexEnvf (GLenum target, GLenum pname, GLfloat param) {
	dllTexEnvf (target, pname, param);
}

static void APIENTRY parTexEnvfv (GLenum target, GLenum pname, const GLfloat *params) {
	dllTexEnvfv (target, pname, params);
}

static void APIENTRY parTexEnvi (GLenum target, GLenum pname, GLint param) {
	dllTexEnvi (target, pname, param);
}

static void APIENTRY parTexEnviv (GLenum target, GLenum pname, const GLint *params) {
	dllTexEnviv (target, pname, params);
}

static void APIENTRY parTexGend (GLenum coord, GLenum pname, GLdouble param) {
	dllTexGend (coord, pname, param);
}

static void APIENTRY parTexGendv (GLenum coord, GLenum pname, const GLdouble *params) {
	dllTexGendv (coord, pname, params);
}

static void APIENTRY parTexGenf (GLenum coord, GLenum pname, GLfloat param) {
	dllTexGenf (coord, pname, param);
}
static void APIENTRY parTexGenfv (GLenum coord, GLenum pname, const GLfloat *params) {
	dllTexGenfv (coord, pname, params);
}

static void APIENTRY parTexGeni (GLenum coord, GLenum pname, GLint param) {
	dllTexGeni (coord, pname, param);
}

static void APIENTRY parTexGeniv (GLenum coord, GLenum pname, const GLint *params) {
	dllTexGeniv (coord, pname, params);
}

static void APIENTRY parTexImage1D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void *pixels) {
	dllTexImage1D (target, level, internalformat, width, border, format, type, pixels);
}

static void APIENTRY parTexImage2D (GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void *pixels) {
	dllTexImage2D (target, level, internalformat, width, height, border, format, type, pixels);
}

static void APIENTRY parTexParameterf (GLenum target, GLenum pname, GLfloat param) {
	dllTexParameterf (target, pname, param);
}

static void APIENTRY parTexParameterfv (GLenum target, GLenum pname, const GLfloat *params) {
	dllTexParameterfv (target, pname, params);
}

static void APIENTRY parTexParameteri (GLenum target, GLenum pname, GLint param) {
	dllTexParameteri (target, pname, param);
}

static void APIENTRY parTexParameteriv (GLenum target, GLenum pname, const GLint *params) {
	dllTexParameteriv (target, pname, params);
}

static void APIENTRY parTexSubImage1D (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void *pixels) {
	dllTexSubImage1D (target, level, xoffset, width, format, type, pixels);
}

static void APIENTRY parTexSubImage2D (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels) {
	dllTexSubImage2D (target, level, xoffset, yoffset, width, height, format, type, pixels);
}

static void APIENTRY parTranslated (GLdouble x, GLdouble y, GLdouble z) {
	dllTranslated (x, y, z);
}

static void APIENTRY parTranslatef (GLfloat x, GLfloat y, GLfloat z) {
	dllTranslatef (x, y, z);
}

static void APIENTRY parVertex2d (GLdouble x, GLdouble y) {
	dllVertex2d (x, y);
}

static void APIENTRY parVertex2dv (const GLdouble *v) {
	dllVertex2dv (v);
}

static void APIENTRY parVertex2f (GLfloat x, GLfloat y) {
	dllVertex2f (x, y);
}

static void APIENTRY parVertex2fv (const GLfloat *v) {
	dllVertex2fv (v);
}

static void APIENTRY parVertex2i (GLint x, GLint y) {
	dllVertex2i (x, y);
}

static void APIENTRY parVertex2iv (const GLint *v) {
	dllVertex2iv (v);
}

static void APIENTRY parVertex2s (GLshort x, GLshort y) {
	dllVertex2s (x, y);
}

static void APIENTRY parVertex2sv (const GLshort *v) {
	dllVertex2sv (v);
}

static void APIENTRY parVertex3d (GLdouble x, GLdouble y, GLdouble z) {
	dllVertex3d (x, y, z);
}

static void APIENTRY parVertex3dv (const GLdouble *v) {
	dllVertex3dv (v);
}

static void APIENTRY parVertex3f (GLfloat x, GLfloat y, GLfloat z) {
	dllVertex3f (x, y, z);
}

static void APIENTRY parVertex3fv (const GLfloat *v) {
	dllVertex3fv (v);
}

static void APIENTRY parVertex3i (GLint x, GLint y, GLint z) {
	dllVertex3i (x, y, z);
}

static void APIENTRY parVertex3iv (const GLint *v) {
	dllVertex3iv (v);
}

static void APIENTRY parVertex3s (GLshort x, GLshort y, GLshort z) {
	dllVertex3s (x, y, z);
}

static void APIENTRY parVertex3sv (const GLshort *v) {
	dllVertex3sv (v);
}

static void APIENTRY parVertex4d (GLdouble x, GLdouble y, GLdouble z, GLdouble w) {
	dllVertex4d (x, y, z, w);
}

static void APIENTRY parVertex4dv (const GLdouble *v) {
	dllVertex4dv (v);
}

static void APIENTRY parVertex4f (GLfloat x, GLfloat y, GLfloat z, GLfloat w) {
	dllVertex4f (x, y, z, w);
}

static void APIENTRY parVertex4fv (const GLfloat *v) {
	dllVertex4fv (v);
}

static void APIENTRY parVertex4i (GLint x, GLint y, GLint z, GLint w) {
	dllVertex4i (x, y, z, w);
}

static void APIENTRY parVertex4iv (const GLint *v) {
	dllVertex4iv (v);
}

static void APIENTRY parVertex4s (GLshort x, GLshort y, GLshort z, GLshort w) {
	dllVertex4s (x, y, z, w);
}

static void APIENTRY parVertex4sv (const GLshort *v) {
	dllVertex4sv (v);
}

static void APIENTRY parVertexPointer (GLint size, GLenum type, GLsizei stride, const void *pointer) {
	dllVertexPointer (size, type, stride, pointer);
}

static void APIENTRY parViewport (GLint x, GLint y, GLsizei width, GLsizei height) {
	dllViewport (x, y, width, height);
}*/
...
void QGL_Shutdown (void) {
	...
	qwglGetPixelFormatAttribivEXT	= NULL;
	qwglGetPixelFormatAttribfvEXT	= NULL;
	qwglChoosePixelFormatEXT		= NULL;
...
qBool QGL_Init (const char *dllName) {
	Com_Printf (0, "QGL_Init: LoadLibrary ( \"%s\" )\n", dllName);
...
void QGL_ToggleLogging (void) {
	...
	if (gl_log->integer) {
		if (!glwState.oglLogFP) {
			...
			glwState.oglLogFP = fopen (buffer, "wt");

			fprintf (glwState.oglLogFP, "%s\n", asctime (newtime));
		}
...
void QGL_LogBeginFrame (void) {
	...
	fprintf (glwState.oglLogFP, "*** R_BeginFrame ***\n");
}
...
void QGL_LogEndFrame (void) {
	...
	fprintf (glwState.oglLogFP, "*** R_EndFrame ***\n");
}

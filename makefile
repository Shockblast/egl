...
OBJS_CLIENT=\
	...
	$(BUILDDIR)/client/r_init.o \
	$(BUILDDIR)/client/r_light.o \
	$(BUILDDIR)/client/r_lightq3.o \
...
$(BUILDDIR)/client/cm_common.o: $(SOURCEDIR)/common/cm_common.c
	$(DO_CC)

$(BUILDDIR)/client/cm_q2_main.o: $(SOURCEDIR)/common/cm_q2_main.c
	$(DO_CC)

$(BUILDDIR)/client/cm_q2_trace.o: $(SOURCEDIR)/common/cm_q2_trace.c
	$(DO_CC)

$(BUILDDIR)/client/cm_q3_main.o: $(SOURCEDIR)/common/cm_q3_main.c
	$(DO_CC)

$(BUILDDIR)/client/cm_q3_patch.o: $(SOURCEDIR)/common/cm_q3_patch.c
	$(DO_CC)

$(BUILDDIR)/client/cm_q3_trace.o: $(SOURCEDIR)/common/cm_q3_trace.c
	$(DO_CC)
...
$(BUILDDIR)/client/cl_console.o: $(SOURCEDIR)/client/cl_console.c
	$(DO_CC)
...
$(BUILDDIR)/client/cl_keys.o: $(SOURCEDIR)/client/cl_keys.c
	$(DO_CC)
...
$(BUILDDIR)/client/gui_cursor.o: $(SOURCEDIR)/client/gui_cursor.c
	$(DO_CC)

$(BUILDDIR)/client/gui_draw.o: $(SOURCEDIR)/client/gui_draw.c
	$(DO_CC)

$(BUILDDIR)/client/gui_events.o: $(SOURCEDIR)/client/gui_events.c
	$(DO_CC)

$(BUILDDIR)/client/gui_init.o: $(SOURCEDIR)/client/gui_init.c
	$(DO_CC)

$(BUILDDIR)/client/gui_items.o: $(SOURCEDIR)/client/gui_items.c
	$(DO_CC)

$(BUILDDIR)/client/gui_keys.o: $(SOURCEDIR)/client/gui_keys.c
	$(DO_CC)

$(BUILDDIR)/client/gui_main.o: $(SOURCEDIR)/client/gui_main.c
	$(DO_CC)

$(BUILDDIR)/client/snd_dma.o: $(SOURCEDIR)/client/snd_dma.c
	$(DO_CC)

$(BUILDDIR)/client/snd_main.o: $(SOURCEDIR)/client/snd_main.c
	$(DO_CC)

$(BUILDDIR)/client/snd_openal.o: $(SOURCEDIR)/client/snd_openal.c
	$(DO_CC)
...
$(BUILDDIR)/client/r_init.o: $(SOURCEDIR)/renderer/r_init.c
	$(DO_CC)

$(BUILDDIR)/client/r_light.o: $(SOURCEDIR)/renderer/r_light.c
	$(DO_CC)

$(BUILDDIR)/client/r_lightq3.o: $(SOURCEDIR)/renderer/r_lightq3.c
	$(DO_CC)
...
$(BUILDDIR)/client/r_sky.o: $(SOURCEDIR)/renderer/r_sky.c
	$(DO_CC)
...
$(BUILDDIR)/client/r_worldq3.o: $(SOURCEDIR)/renderer/r_worldq3.c
	$(DO_CC)
...
$(BUILDDIR)/client/net_linux.o: $(SOURCEDIR)/linux/net_linux.c
	$(DO_CC)
...
$(BUILDDIR)/client/x11_main.o: $(SOURCEDIR)/linux/x11_main.c
	$(DO_CC)

$(BUILDDIR)/client/x11_utils.o: $(SOURCEDIR)/linux/x11_utils.c
	$(DO_CC)

$(BUILDDIR)/client/con_linux.o: $(SOURCEDIR)/linux/con_linux.c
	$(DO_CC)

$(BUILDDIR)/client/infostrings.o: $(SOURCEDIR)/shared/infostrings.c
	$(DO_CC)

$(BUILDDIR)/client/m_angles.o: $(SOURCEDIR)/shared/m_angles.c
	$(DO_CC)

$(BUILDDIR)/client/m_bounds.o: $(SOURCEDIR)/shared/m_bounds.c
	$(DO_CC)

$(BUILDDIR)/client/m_mat3.o: $(SOURCEDIR)/shared/m_mat3.c
	$(DO_CC)

$(BUILDDIR)/client/m_mat4.o: $(SOURCEDIR)/shared/m_mat4.c
	$(DO_CC)

$(BUILDDIR)/client/m_plane.o: $(SOURCEDIR)/shared/m_plane.c
	$(DO_CC)

$(BUILDDIR)/client/m_quat.o: $(SOURCEDIR)/shared/m_quat.c
	$(DO_CC)
...
$(BUILDDIR)/client/unzip.o: $(SOURCEDIR)/include/minizip/unzip.c
	$(DO_CC)

$(BUILDDIR)/client/ioapi.o: $(SOURCEDIR)/include/minizip/ioapi.c
	$(DO_CC)
...
OBJS_DEDICATED=\
	...
	\
	$(BUILDDIR)/dedicated/net_linux.o \
	$(BUILDDIR)/dedicated/sys_linux.o \
	$(BUILDDIR)/dedicated/con_linux.o \
	\
...
$(BUILDDIR)/dedicated/cbuf.o: $(SOURCEDIR)/common/cbuf.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/cm_common.o: $(SOURCEDIR)/common/cm_common.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/cm_q2_main.o: $(SOURCEDIR)/common/cm_q2_main.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/cm_q2_trace.o: $(SOURCEDIR)/common/cm_q2_trace.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/cm_q3_main.o: $(SOURCEDIR)/common/cm_q3_main.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/cm_q3_patch.o: $(SOURCEDIR)/common/cm_q3_patch.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/cm_q3_trace.o: $(SOURCEDIR)/common/cm_q3_trace.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/cmd.o: $(SOURCEDIR)/common/cmd.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/common.o: $(SOURCEDIR)/common/common.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/crc.o: $(SOURCEDIR)/common/crc.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/cvar.o: $(SOURCEDIR)/common/cvar.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/files.o: $(SOURCEDIR)/common/files.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/md4.o: $(SOURCEDIR)/common/md4.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/memory.o: $(SOURCEDIR)/common/memory.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/net_chan.o: $(SOURCEDIR)/common/net_chan.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/net_msg.o: $(SOURCEDIR)/common/net_msg.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sv_ccmds.o: $(SOURCEDIR)/server/sv_ccmds.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sv_ents.o: $(SOURCEDIR)/server/sv_ents.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sv_gameapi.o: $(SOURCEDIR)/server/sv_gameapi.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sv_init.o: $(SOURCEDIR)/server/sv_init.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sv_main.o: $(SOURCEDIR)/server/sv_main.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sv_pmove.o: $(SOURCEDIR)/server/sv_pmove.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sv_send.o: $(SOURCEDIR)/server/sv_send.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sv_user.o: $(SOURCEDIR)/server/sv_user.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sv_world.o: $(SOURCEDIR)/server/sv_world.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/net_linux.o: $(SOURCEDIR)/linux/net_linux.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/sys_linux.o: $(SOURCEDIR)/linux/sys_linux.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/con_linux.o: $(SOURCEDIR)/linux/con_linux.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/infostrings.o: $(SOURCEDIR)/shared/infostrings.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/m_angles.o: $(SOURCEDIR)/shared/m_angles.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/m_bounds.o: $(SOURCEDIR)/shared/m_bounds.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/m_mat3.o: $(SOURCEDIR)/shared/m_mat3.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/m_mat4.o: $(SOURCEDIR)/shared/m_mat4.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/m_plane.o: $(SOURCEDIR)/shared/m_plane.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/m_quat.o: $(SOURCEDIR)/shared/m_quat.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/mathlib.o: $(SOURCEDIR)/shared/mathlib.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/mersennetwister.o: $(SOURCEDIR)/shared/mersennetwister.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/shared.o: $(SOURCEDIR)/shared/shared.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/string.o: $(SOURCEDIR)/shared/string.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/unzip.o: $(SOURCEDIR)/include/minizip/unzip.c
	$(DO_DED_CC)

$(BUILDDIR)/dedicated/ioapi.o: $(SOURCEDIR)/include/minizip/ioapi.c
	$(DO_DED_CC)
...
$(BUILDDIR)/baseq2/cgame/cg_console.o: $(SOURCEDIR)/cgame/cg_console.c
	$(DO_SHLIB_CC)
...
$(BUILDDIR)/baseq2/cgame/cg_keys.o: $(SOURCEDIR)/cgame/cg_keys.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/cg_light.o: $(SOURCEDIR)/cgame/cg_light.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/cg_loadscreen.o: $(SOURCEDIR)/cgame/cg_loadscreen.c
	$(DO_SHLIB_CC)
...
$(BUILDDIR)/baseq2/cgame/m_main.o: $(SOURCEDIR)/cgame/menu/m_main.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_mp.o: $(SOURCEDIR)/cgame/menu/m_mp.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_mp_downloading.o: $(SOURCEDIR)/cgame/menu/m_mp_downloading.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_mp_join.o: $(SOURCEDIR)/cgame/menu/m_mp_join.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_mp_join_addrbook.o: $(SOURCEDIR)/cgame/menu/m_mp_join_addrbook.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_mp_player.o: $(SOURCEDIR)/cgame/menu/m_mp_player.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_mp_start.o: $(SOURCEDIR)/cgame/menu/m_mp_start.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_mp_start_dmflags.o: $(SOURCEDIR)/cgame/menu/m_mp_start_dmflags.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_opts.o: $(SOURCEDIR)/cgame/menu/m_opts.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_opts_controls.o: $(SOURCEDIR)/cgame/menu/m_opts_controls.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_opts_effects.o: $(SOURCEDIR)/cgame/menu/m_opts_effects.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_opts_gloom.o: $(SOURCEDIR)/cgame/menu/m_opts_gloom.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_opts_hud.o: $(SOURCEDIR)/cgame/menu/m_opts_hud.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_opts_input.o: $(SOURCEDIR)/cgame/menu/m_opts_input.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_opts_misc.o: $(SOURCEDIR)/cgame/menu/m_opts_misc.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_opts_screen.o: $(SOURCEDIR)/cgame/menu/m_opts_screen.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_opts_sound.o: $(SOURCEDIR)/cgame/menu/m_opts_sound.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_quit.o: $(SOURCEDIR)/cgame/menu/m_quit.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_sp.o: $(SOURCEDIR)/cgame/menu/m_sp.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_sp_credits.o: $(SOURCEDIR)/cgame/menu/m_sp_credits.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_sp_loadgame.o: $(SOURCEDIR)/cgame/menu/m_sp_loadgame.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_sp_savegame.o: $(SOURCEDIR)/cgame/menu/m_sp_savegame.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_vid.o: $(SOURCEDIR)/cgame/menu/m_vid.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_vid_exts.o: $(SOURCEDIR)/cgame/menu/m_vid_exts.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_vid_settings.o: $(SOURCEDIR)/cgame/menu/m_vid_settings.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/menu.o: $(SOURCEDIR)/cgame/menu/menu.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/ui_backend.o: $(SOURCEDIR)/cgame/ui/ui_backend.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/ui_cursor.o: $(SOURCEDIR)/cgame/ui/ui_cursor.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/ui_draw.o: $(SOURCEDIR)/cgame/ui/ui_draw.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/ui_items.o: $(SOURCEDIR)/cgame/ui/ui_items.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/ui_keys.o: $(SOURCEDIR)/cgame/ui/ui_keys.c
	$(DO_SHLIB_CC)
...
$(BUILDDIR)/baseq2/cgame/m_angles.o: $(SOURCEDIR)/shared/m_angles.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_bounds.o: $(SOURCEDIR)/shared/m_bounds.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_mat3.o: $(SOURCEDIR)/shared/m_mat3.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_mat4.o: $(SOURCEDIR)/shared/m_mat4.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_plane.o: $(SOURCEDIR)/shared/m_plane.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/cgame/m_quat.o: $(SOURCEDIR)/shared/m_quat.c
	$(DO_SHLIB_CC)
...
$(BUILDDIR)/baseq2/cgame/m_flash.o: $(SOURCEDIR)/game/m_flash.c
	$(DO_SHLIB_CC)
...
$(BUILDDIR)/baseq2/game/g_ai.o: $(SOURCEDIR)/game/g_ai.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_chase.o: $(SOURCEDIR)/game/g_chase.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_cmds.o: $(SOURCEDIR)/game/g_cmds.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_combat.o: $(SOURCEDIR)/game/g_combat.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_func.o: $(SOURCEDIR)/game/g_func.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_items.o: $(SOURCEDIR)/game/g_items.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_main.o: $(SOURCEDIR)/game/g_main.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_misc.o: $(SOURCEDIR)/game/g_misc.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_monster.o: $(SOURCEDIR)/game/g_monster.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_phys.o: $(SOURCEDIR)/game/g_phys.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_save.o: $(SOURCEDIR)/game/g_save.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_spawn.o: $(SOURCEDIR)/game/g_spawn.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_svcmds.o: $(SOURCEDIR)/game/g_svcmds.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_target.o: $(SOURCEDIR)/game/g_target.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_trigger.o: $(SOURCEDIR)/game/g_trigger.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_turret.o: $(SOURCEDIR)/game/g_turret.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_utils.o: $(SOURCEDIR)/game/g_utils.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/g_weapon.o: $(SOURCEDIR)/game/g_weapon.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_actor.o: $(SOURCEDIR)/game/m_actor.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_berserk.o: $(SOURCEDIR)/game/m_berserk.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_boss2.o: $(SOURCEDIR)/game/m_boss2.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_boss31.o: $(SOURCEDIR)/game/m_boss31.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_boss32.o: $(SOURCEDIR)/game/m_boss32.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_boss3.o: $(SOURCEDIR)/game/m_boss3.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_brain.o: $(SOURCEDIR)/game/m_brain.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_chick.o: $(SOURCEDIR)/game/m_chick.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_flash.o: $(SOURCEDIR)/game/m_flash.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_flipper.o: $(SOURCEDIR)/game/m_flipper.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_float.o: $(SOURCEDIR)/game/m_float.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_flyer.o: $(SOURCEDIR)/game/m_flyer.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_gladiator.o: $(SOURCEDIR)/game/m_gladiator.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_gunner.o: $(SOURCEDIR)/game/m_gunner.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_hover.o: $(SOURCEDIR)/game/m_hover.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_infantry.o: $(SOURCEDIR)/game/m_infantry.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_insane.o: $(SOURCEDIR)/game/m_insane.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_medic.o: $(SOURCEDIR)/game/m_medic.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_move.o: $(SOURCEDIR)/game/m_move.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_mutant.o: $(SOURCEDIR)/game/m_mutant.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_parasite.o: $(SOURCEDIR)/game/m_parasite.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_soldier.o: $(SOURCEDIR)/game/m_soldier.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_supertank.o: $(SOURCEDIR)/game/m_supertank.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_tank.o: $(SOURCEDIR)/game/m_tank.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/p_client.o: $(SOURCEDIR)/game/p_client.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/p_hud.o: $(SOURCEDIR)/game/p_hud.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/p_trail.o: $(SOURCEDIR)/game/p_trail.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/p_view.o: $(SOURCEDIR)/game/p_view.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/p_weapon.o: $(SOURCEDIR)/game/p_weapon.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/infostrings.o: $(SOURCEDIR)/shared/infostrings.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_angles.o: $(SOURCEDIR)/shared/m_angles.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_bounds.o: $(SOURCEDIR)/shared/m_bounds.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_mat3.o: $(SOURCEDIR)/shared/m_mat3.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_mat4.o: $(SOURCEDIR)/shared/m_mat4.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_plane.o: $(SOURCEDIR)/shared/m_plane.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/m_quat.o: $(SOURCEDIR)/shared/m_quat.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/mathlib.o: $(SOURCEDIR)/shared/mathlib.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/mersennetwister.o: $(SOURCEDIR)/shared/mersennetwister.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/shared.o: $(SOURCEDIR)/shared/shared.c
	$(DO_SHLIB_CC)

$(BUILDDIR)/baseq2/game/string.o: $(SOURCEDIR)/shared/string.c
	$(DO_SHLIB_CC)

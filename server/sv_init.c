...
================
*/
static void SV_SpawnServer (char *server, char *spawnPoint, int serverState, qBool attractLoop, qBool loadGame, qBool devMap)
{
	int		i;
	uint32	checkSum;
	...
	if (Cvar_GetFloatValue ("deathmatch")) {
		...
		sv_airAcceleration = sv_airaccelerate->value;
	}
	else {
...
======================
*/
void SV_Map (qBool attractLoop, char *levelString, qBool loadGame, qBool devMap)
{

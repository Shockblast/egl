...
=================
*/
void M_PushMenu (uiFrameWork_t *frameWork, void (*drawFunc) (void), struct sfx_s *(*closeFunc) (void), struct sfx_s *(*keyFunc) (uiFrameWork_t *fw, int keyNum))
{
...
=================
*/
struct sfx_s *M_KeyHandler (uiFrameWork_t *fw, int keyNum)
{
	if (keyNum == K_ESCAPE) {
		M_PopMenu ();
		return NULL;

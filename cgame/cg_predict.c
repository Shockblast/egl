...
====================
*/
static void CG_ClipMoveToEntities (vec3_t start, vec3_t mins, vec3_t maxs, vec3_t end, int ignoreNum, trace_t *tr)
{
	int				i, x, zd, zu;
	trace_t			trace;
	int				headnode;
...
static trace_t CG_PMLTrace (vec3_t start, vec3_t mins, vec3_t maxs, vec3_t end)
{
	...
	// Check all other solid models
	CG_ClipMoveToEntities (start, mins, maxs, end, cg.playerNum+1, &t);

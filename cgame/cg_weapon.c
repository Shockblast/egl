...
void CG_WeapRegister (void) {
	CGI_Cmd_AddCommand ("gun_next",		CG_Gun_FrameNext_f,	"Increments view weapon frame number");
	CGI_Cmd_AddCommand ("gun_prev",		CG_Gun_FramePrev_f,	"Decrements view weapon frame number");
	CGI_Cmd_AddCommand ("gun_model",	CG_Gun_Model_f,		"Changes the view weapon model");
}
...
void CG_WeapUnregister (void) {
	CGI_Cmd_RemoveCommand ("gun_next");
	CGI_Cmd_RemoveCommand ("gun_prev");
	CGI_Cmd_RemoveCommand ("gun_model");
}

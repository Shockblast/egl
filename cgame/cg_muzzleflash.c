...
void CG_ParseMuzzleFlash (void)
{
	...
	case MZ_SHOTGUN:
		...
		cgi.Snd_StartSound (NULL, entNum, CHAN_AUTO, cgMedia.mz.shotgunReloadSfx, volume, ATTN_NORM, 0.1f);
		break;
	...
	case MZ_CHAINGUN2:
		...
		cgi.Snd_StartSound (NULL, entNum, CHAN_WEAPON, cgMedia.mz.machineGunSfx[(rand () % 5)], volume, ATTN_NORM, 0);
		cgi.Snd_StartSound (NULL, entNum, CHAN_WEAPON, cgMedia.mz.machineGunSfx[(rand () % 5)], volume, ATTN_NORM, 0.05f);
		break;
	...
	case MZ_CHAINGUN3:
		...
		cgi.Snd_StartSound (NULL, entNum, CHAN_WEAPON, cgMedia.mz.machineGunSfx[(rand () % 5)], volume, ATTN_NORM, 0);
		cgi.Snd_StartSound (NULL, entNum, CHAN_WEAPON, cgMedia.mz.machineGunSfx[(rand () % 5)], volume, ATTN_NORM, 0.033f);
		cgi.Snd_StartSound (NULL, entNum, CHAN_WEAPON, cgMedia.mz.machineGunSfx[(rand () % 5)], volume, ATTN_NORM, 0.066f);
		break;
	...
	case MZ_ROCKET:
		...
		cgi.Snd_StartSound (NULL, entNum, CHAN_AUTO, cgMedia.mz.rocketReloadSfx, volume, ATTN_NORM, 0.1f);
		break;
	...
	case MZ_GRENADE:
		...
		cgi.Snd_StartSound (NULL, entNum, CHAN_AUTO, cgMedia.mz.grenadeReloadSfx, volume, ATTN_NORM, 0.1f);
		break;
...
void CG_ParseMuzzleFlash2 (void)
{
	...
	// locate the origin
	AngleVectors (cg_entityList[entNum].current.angles, forward, right, NULL);
...
//	case MZ2_CARRIER_ROCKET_4:
	...
	case MZ2_WIDOW_RAIL:		// PMM
		VectorSet (dl->color, 0.5f, 0.5f, 1);
		break;

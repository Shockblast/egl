...
typedef struct clientInfo_s {
	...
	struct model_s		*weaponModels[MAX_CLIENTWEAPONMODELS];
} clientInfo_t;
...
typedef struct cgState_s {
	...
	struct model_s		*modelCfgDraw[MAX_CS_MODELS];
...
#define CG_HSCALE (((float)cg.glConfig.vidWidth / 640.0f))
#define CG_VSCALE (((float)cg.glConfig.vidHeight / 480.0f))

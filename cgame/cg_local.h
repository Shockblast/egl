...
typedef struct cgMedia_s {
	...
	// load screen images
	struct image_s	*loadSplash;
	struct image_s	*loadBarPos;
	struct image_s	*loadBarNeg;
	struct image_s	*loadNoMap;
...
#define CG_HSCALE ((float)(cg.vidWidth / 640.0))
#define CG_VSCALE ((float)(cg.vidHeight / 480.0))

...
static void VIDSettingsMenu_SetValues (void) {
	if (strcmp (uii.Cvar_VariableString ("gl_driver"), "3dfxgl") == 0)		m_vidsettings_menu.ref_list.curvalue = REF_3DFX;
	else if (strcmp (uii.Cvar_VariableString ("gl_driver"), "pvrgl") == 0)	m_vidsettings_menu.ref_list.curvalue = REF_POWERVR;
	...
	if (!strcmp (uii.Cvar_VariableString ("gl_texturemode"), "GL_LINEAR_MIPMAP_LINEAR"))		m_vidsettings_menu.tm_list.curvalue = 1;
	else if (!strcmp (uii.Cvar_VariableString ("gl_texturemode"), "GL_LINEAR_MIPMAP_NEAREST"))	m_vidsettings_menu.tm_list.curvalue = 0;
...
void VIDSettingsMenu_Init (void) {
	...
	m_vidsettings_menu.framework.nitems	= 0;
...
================
*/
const char *VIDSettingsMenu_Key (int key) {

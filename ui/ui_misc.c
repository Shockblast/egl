...
void MiscMenu_Init (void) {
	...
	m_misc_menu.framework.numItems	= 0;

	UI_Banner (&m_misc_menu.banner, uiMedia.banners.options, &y);
	...
	m_misc_menu.back_action.generic.callBack	= Menu_Pop;
...
=============
*/
struct sfx_s *MiscMenu_Key (int key) {

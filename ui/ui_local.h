...
typedef struct uiMedia_s {
	...
	// sounds
	struct sfx_s	*menuInSfx;
	struct sfx_s	*menuMoveSfx;
	struct sfx_s	*menuOutSfx;
	...
	// menu banners
	struct image_s	*addressBookBanner;
	struct image_s	*multiplayerBanner;
	struct image_s	*startServerBanner;
	struct image_s	*joinServerBanner;
	struct image_s	*optionsBanner;
	struct image_s	*gameBanner;
	struct image_s	*loadGameBanner;
	struct image_s	*saveGameBanner;
	struct image_s	*videoBanner;
	struct image_s	*quitBanner;

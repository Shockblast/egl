...
void DLOptionsMenu_Init (void) {
	...
	m_dlopts_menu.framework.nitems	= 0;

	UI_Banner (&m_dlopts_menu.banner, uiMedia.multiplayerBanner, &y);
	...
	m_dlopts_menu.back_action.generic.callback		= Back_Menu;
...
=============
*/
const char *DLOptionsMenu_Key (int key) {

...
static void MainCursorDrawFunc (uiFrameWork_t *menu) {
	...
	uii.Img_GetSize (uiMedia.menus.mainGame, NULL, &h);

	y = (((m_main_menu.framework.cursor%MAIN_ITEMS) * (h + 5)));

	uii.Img_GetSize (uiMedia.menus.mainCursors[cursorNum], &w, &h);

	UI_DrawPic (uiMedia.menus.mainCursors[cursorNum],
...
void MainMenu_Init (void) {
	...
	m_main_menu.game_menu.image				= uiMedia.menus.mainGame;
	m_main_menu.game_menu.selImage			= uiMedia.menus.mainGameSel;
	m_main_menu.game_menu.generic.callBack	= SP_Menu;
	uii.Img_GetSize (uiMedia.menus.mainGame, NULL, &height);
	...
	m_main_menu.multiplayer_menu.image				= uiMedia.menus.mainMultiplayer;
	m_main_menu.multiplayer_menu.selImage			= uiMedia.menus.mainMultiplayerSel;
	m_main_menu.multiplayer_menu.generic.callBack	= MP_Menu;
	uii.Img_GetSize (uiMedia.menus.mainMultiplayer, NULL, &height);
	y += max (((height + 5) * UIFT_SCALE), 5);
	...
	m_main_menu.options_menu.image				= uiMedia.menus.mainOptions;
	m_main_menu.options_menu.selImage			= uiMedia.menus.mainOptionsSel;
	m_main_menu.options_menu.generic.callBack	= OPTS_Menu;
	uii.Img_GetSize (uiMedia.menus.mainOptions, NULL, &height);
	y += max (((height + 5) * UIFT_SCALE), 5);
	...
	m_main_menu.video_menu.image			= uiMedia.menus.mainVideo;
	m_main_menu.video_menu.selImage			= uiMedia.menus.mainVideoSel;
	m_main_menu.video_menu.generic.callBack	= VID_Menu;
	uii.Img_GetSize (uiMedia.menus.mainVideo, NULL, &height);
	y += max (((height + 5) * UIFT_SCALE), 5);
	...
	m_main_menu.quit_menu.image				= uiMedia.menus.mainQuit;
	m_main_menu.quit_menu.selImage			= uiMedia.menus.mainQuitSel;
	m_main_menu.quit_menu.generic.callBack	= QUIT_Menu;

	uii.Img_GetSize (uiMedia.menus.mainCursors[cursorNum], &curWidth, NULL);
	uii.Img_GetSize (uiMedia.menus.mainPlaque, &plaqueWidth, NULL);
	uii.Img_GetSize (uiMedia.menus.mainLogo, &logoWidth, NULL);
	...
	m_main_menu.plaque_pic.image			= uiMedia.menus.mainPlaque;
	m_main_menu.plaque_pic.selImage			= NULL;
	uii.Img_GetSize (uiMedia.menus.mainPlaque, NULL, &height);
	...
	m_main_menu.idlogo_pic.image			= uiMedia.menus.mainLogo;

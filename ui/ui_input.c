...
void InputMenu_Init (void) {
	...
	m_input_menu.framework.nitems	= 0;

	UI_Banner (&m_input_menu.banner, uiMedia.optionsBanner, &y);
	...
	m_input_menu.ui_sensitivity_slider.minvalue				= 2;
	m_input_menu.ui_sensitivity_slider.maxvalue				= 52;
	...
	m_input_menu.back_action.generic.callback	= Back_Menu;
...
=============
*/
const char *InputMenu_Key (int key) {

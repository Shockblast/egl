...
void MultiplayerMenu_Init (void) {
	...
	m_multiplayer_menu.framework.nitems	= 0;

	UI_Banner (&m_multiplayer_menu.banner, uiMedia.multiplayerBanner, &y);
	...
	m_multiplayer_menu.back_action.generic.callback		= Back_Menu;
...
=============
*/
const char *MultiplayerMenu_Key (int key) {

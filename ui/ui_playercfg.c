...
void PlayerConfigMenu_Draw (void)
{
	...
	// player
	entity[0].model = uii.R_RegisterModel (Q_VarArgs ("players/%s/tris.md2",
		m_playerConfigMenu.modelInfo[m_playerConfigMenu.modelList.curValue].directory));
	if (entity[0].model) {
		entity[0].skin = uii.R_RegisterSkin (Q_VarArgs ("players/%s/%s.pcx",
			m_playerConfigMenu.modelInfo[m_playerConfigMenu.modelList.curValue].directory,
			m_playerConfigMenu.modelInfo[m_playerConfigMenu.modelList.curValue].skinDisplayNames[m_playerConfigMenu.skinList.curValue]));
	...
	// pic selection
	icon = uii.R_RegisterPic (Q_VarArgs ("players/%s/%s_i.pcx", 
			m_playerConfigMenu.modelInfo[m_playerConfigMenu.modelList.curValue].directory,
			m_playerConfigMenu.modelInfo[m_playerConfigMenu.modelList.curValue].skinDisplayNames[m_playerConfigMenu.skinList.curValue]));
	if (icon) {
		int		width;
...
void UI_PlayerConfigMenu_f (void)
{
	...
	UI_DrawString (midrow + (UIFT_SIZEMED*2), midcol + (UIFT_SIZEMED*3), 0, UIFT_SCALEMED,	"being listed, and this might take ",		colorGreen);
